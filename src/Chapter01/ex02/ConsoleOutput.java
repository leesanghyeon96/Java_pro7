...
public class ConsoleOutput {
	...
	public static void main(String[] args) {
		...
		System.out.println("안녕" + "하세요");  //문자열 + 문자열 : +는 연결연산자
		// 출력후 enter가 들어감
		// 출력시 정수, 실수 : ""를 처리하면 안됨.
		// + : 더하기 연산자를 뜻함.
		...
		System.out.println("문자"+ 1 + 2);	// 문자12 로 출력
		
		System.out.println(1 + 2 + "문자");	// 3문자 로 출력
		
		System.out.println("=======변수에 값을 할당후 출력 ==========");
		// 변수선언 : 자료형 변수명 = 변수의 값
		int a = 5;   // 정수형 a변수에 정수값 5를 넣어라  (== : 같다)
					// int a = 5; : 5를 a에 넣어라, int(정수)
					//   =   : = 오른쪽의 값을 = 왼쪽 변수에 값을 할당해라.
					//   ==  : 같다.
		System.out.println(a);		// 변수를 출력 할때는 ""를 넣으면 안된다.
		
		String b = "하세요";		//String은 문자열 변수 선언시 사용
		...
		// %s : 뒤의 문자열을 가지고 옵니다.
		System.out.printf("%s은 %s 가 매우 매우 %s 니다\n" , "오늘", "날씨", "맑습");
		
		// %f : 문자열 뒤의 실수 값 불러올 때 사용
		// %4.2f : 4 = 전체 4자리, 2 = 소숫점 이하 2자리까지 잘라서 출력
		System.out.printf("나의 몸무게는 %f입니다\n", 75.1234567);
		System.out.printf("나의 몸무게는 %4.2f입니다\n", 75.1234567);
		
		System.out.printf("오늘의 온도는 %4.2f도 이고, %s %4.2f 입니다.", 17.33, "나의 몸무게는", 75.5);

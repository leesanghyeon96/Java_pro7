...
public class TypeCasting2 {
	...
	public static void main(String[] args) {
		...
		//1. 자동타입변환 (업캐스팅 : 낮은 자료형에서 높은 자료형으로 자동으로 변환)
		...
		//2. 수동타입변환 (다운 캐스팅 : 높은 자료형에서 낮은 자료형으로 변환)
		int value4 = (int) 3.5;		//double => int 로 다운캐스팅
		float value5 = (float)7.8 ;	//7.8f;		//double =>float 다운캐스팅

...
public class Sharing_String_Object {
	...
	public static void main(String[] args) {
		...
		//			new 생성자를 사용해서 객체를 생성할때는 공유되지 않는다. Heap공간에 별도의 공간에 생성됨
		
		String str1 = new String("안녕");		//동일한 글자지만 new를 쓰면 별도의 메모리 공간을 가지고있다.
		String str2 = "안녕";
		String str3 = "안녕";
		String str4 = "안녕";
		...
		//			equals() : Heap의 값을 비교 참조객체.equals(비교할객체);

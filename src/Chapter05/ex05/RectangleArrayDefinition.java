...
public class RectangleArrayDefinition {
	...
	public static void main(String[] args) {
		// 다차원 배열 ( 2차원 배열 )
		//	- 정방형 배열		: row(행) 에 대해서 열 (colum, fild) 이 동일한 배열
		//	- 비정방형 배열		: row(행) 에 대해서 열 (colum, fild) 이 동일하지 않는 배열
		
		//1. 정방형 배열 선언 방법1
		int[][] arr1 = new int[3][4];	//첫[]는 행의 개수를 뜻하고 두번째[]는 열을 뜻함
										// 3 : 행의 갯수 ( 0, 1, 2 ) 
										// 4 : 열의 갯수 ( 0, 1, 2, 3 )
			...
			//4. 정방형 배열 선언과 동시에 값 넣기 : <주의> 방크기를 지정하면 오류 발생
			System.out.println("====================");
			int[][] arr11= new int[][] { {1,2,3}, {4,5,6} }; 
			//{1,2,3}=행의 index0번, {4,5,6}=행의 index1번
			//1 - 열의 index0번...
			System.out.println(arr11[1][1]);
			...
			//5. 정방형 배열 선언과 동시에 값넣기2 : 선언, 값을 분리 할 수 없다.

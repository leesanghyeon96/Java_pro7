...
public class Initial_Value {
	...
	public static void main(String[] args) {
		...
		int value1;
	//	System.out.println(value1);		//오류발생 : 초기값이 설정되어 있지 않음 
		int[] value2;
	//	value2 = new int[3];				//new : 주소값을 만든다.
	//	System.out.println(value2);//오류발생 : value2에 Heap 영역의 주소값이 없다.
		...
		//2-1 기본자료형 배열
		boolean[] arr1 = new boolean[3];	//Heap영역에 방3개를 만드는 순간 기본값으로 false 가 각 방에 할당되어 있다.

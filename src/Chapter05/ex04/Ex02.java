...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		int [] arr1;			//배열 선언
		arr1 = new int[500];	//배열의 방크기를 정의 . new : 메모리의 Heap공간에 저장하겠다
		...
		for ( int i = 0 ; i < arr1.length; i++) {	//값을 더 추가할 수 있다.
			arr1[i] = i + 1 ;
		}
		
		//3. 각각의 배열방에 저장된 내용을 출력 : For, Enhanced For, Arrays.toString(arr1)
		...
		System.out.println("==== Arrays.toStint(arr1) 문을 사용해서 배열의 각 방의 내용을 출력 =====");

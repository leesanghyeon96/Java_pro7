...
public class Continue_Control_Statement {
	...
	public static void main(String[] args) {
		// continue : 제어문 내에서 사용되는 break 와 비슷하게 사용되는 키워드
		// -- 반복문 내에서 continue를 만나면 continue 아래의 실행 블락을 실행하지 않고 증감식으로 이동 후 작동
		
		//1. 단일 loop 에서 continue
		for ( int i = 0 ; i < 10 ; i++) {
			continue ;					//단독으로 쓰이는 경우는 거의 없다.(break와 마찬가지)

...
//1. 자식 클래스에서 추상클래스의 메소드를 구현한 클래스를 생성
class B extends A {		
	@Override
	void cry() {	//중괄호 블락이 있으면 내용이 없더라도 구현이 된것임
		System.out.println("모든 동물은 웁니다. (자식 클래스에서 추상 메소드를 완성힘)");
	}
}
...
public class Abstract_Class02 {
	...
	public static void main(String[] args) {
		...
		// 두번쨰 방법 : 구현한 클래스 없이 바로 출력 (익명 클래스 사용), C : 추상 클래스 (객체화 불가능)
			//익명 클래스 : 
		C c1 = new C() {

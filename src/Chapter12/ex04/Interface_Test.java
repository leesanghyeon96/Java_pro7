...
//인터페이스에서 선언된 메소드를 구현하는 방법 2가지
	//1. 인터페이스에 선언된 메소드를 구현한 클래스를 생성 후 출력하는 방법
		//매번 자주 사용하는 경우
...
class Aa implements A {
	@Override
	public void abc() {		//public 이 있는걸 주의, 없으면 오류
...
public class Interface_Test {
	...
	public static void main(String[] args) {
		...
		//1. A 인터페이스의 선언된 메소드를 구현한 메소드를 생성 후 출력 : Aa 
		...
		//인터페이스B의 구현되지 않은 bcd()를 오버라이딩해서 구현하면 가능함
		b1.bcd();

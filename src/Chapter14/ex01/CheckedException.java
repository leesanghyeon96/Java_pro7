...
class A {	//A객체를 복사 , throws : 예외를 전가함, 메소드를 호출하는곳에서 예외를 처리하라
	...
	protected Object clone() throws CloneNotSupportedException{ //리턴타입 : Object
		return super.clone();
	}
}
...
// Exception 은 너무나도 많다.
	public static void main(String[] args) {
		// 예외 (Exception) : 프로그램 작성시 문제가 발생이 되었을때, 프로그램이 종료되지 않도록 처리
		...
		//일반 예외 : 컴파일 단께에서 예외 처리를 하라고 알려줌
		
		//1. IntterupedException : 인터럽트가 발생 했을때 예외처리

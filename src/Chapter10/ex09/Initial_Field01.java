...
class Student {	//extends Object가 생략되어있음
	//필드
	String name;
	int stuID;
	int age;
	...
	public void setMonth(int month) {
		if ( month >= 1 && month <= 12) {
			...
			System.out.println("잘못된 입력값입니다. 1 ~ 12 사이의 정수값을 넣으세요.");
			return;		//프로그램 종료
		}
	}
	...
	@Override
	public String toString() {		//Object 클래스의 메소드 , 모든 자바의 클래스는 Object 상속
...
public class Initial_Field01 {
	...
	public static void main(String[] args) {
		...
		//		: client 에게 값을 받아서 DAO 에 값을 전송
					// DAO (Data Acess Object) : DataBase 에 값을 Insurt, Update, Delete
		//		getter(필드의 값을 읽을때), setter(필드의 값을 할당할때)를 사용해서 값을 
		
		//1. 객체를 생성후 직접 필드의 값을 할당. (잘 안씀)
		...
		Student s2 = new Student("이순신",2222,30,"서울 강남구","010-2222-2222",85.5, 50);
		System.out.println(s2);			//보통 객체만 찍고 출력함

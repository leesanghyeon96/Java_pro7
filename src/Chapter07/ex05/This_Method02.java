...
public class This_Method02 {
	...
	public static void main(String[] args) {
		// this() : 생성자 내부에서 사용이 되고 , 첫 라인에 위치 해야되고, 자신의 객에의 다른 생성자 호출
				//생성자를 여러개를 생성할때 코드를 중려 줄 수 있다.
		
		//1. Aa 클래스에서 생성자 호출
			// 기본생성자 호출
		System.out.println("====Aa 클래스의 기본생성자 호출====");
		Aa a1 = new Aa();
		a1.print();		//메모리에 있는 값을 찍어준다.
		...
		//2. BB 클래스의 생성자 호출
			...
			//기본생성자 호출
		System.out.println("====Bb클래스의 기본 생성자 호출====");
		Bb b1 = new Bb();
		b1.print();
		
		System.out.println("====Bb클래스의 매개변수 정수 1개인 생성자 호출====");
		Bb b2 = new Bb(10);
		b2.print();
		
		System.out.println("====Bb클래스의 매개변수 정수 2개인 생성자 호출====");
		Bb b3 = new Bb(10,20);
		b3.print();
		
		System.out.println("====Bb클래스의 매개변수 정수 3개인 생성자 호출====");
		Bb b4 = new Bb(10,20,30);
		b4.print();
		
		System.out.println("====Bb클래스의 매개변수 정수 4개인 생성자 호출====");

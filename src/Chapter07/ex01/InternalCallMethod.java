...
public class InternalCallMethod {
	...
	public static void main(String[] args) {
		// 클래스 내부에서 다른 메소드 호출
			//main 메소드는 메서드 이름 앞에 public : 다른 패키지에서 호출이 가능 하다.
			//static : 인스턴스화 하지 않고 사용 가능하다. 객체를 생성하지 않고 사용 가능하다. (new없이)
	...
	public static double sum(int m ,double n) {		//int로 하면 다운캐스팅을 해줘야함
		return m + n;
	}
